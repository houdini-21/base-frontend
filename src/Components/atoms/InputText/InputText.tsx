    ...
    <div className={classNames('flex flex-col', styleClasses)}>
      ...
      <label
        ...
        className={classNames('text-sm font-medium mb-1', {
          'text-red-500': error, // Color rojo para errores
          'text-blue-500': isFocused && !error, // Azul para el enfoque
          'text-gray-700': value !== '' && !error, // Texto oscuro si hay un valor
          'text-gray-500': value === '' && !isFocused && !error, // Gris claro si no hay valor ni enfoque
      ...
      <div className="relative">
        ...
        <input
          ...
          onChange={onChange}
          className={classNames(
            'border rounded-md px-4 py-3 text-sm outline-none transition-all w-full',
            classNameInput,
            {
              ...
              'border-gray-200 text-gray-500': value === '' && !isFocused && !disabled, // Gris claro para inactivo
              'border-gray-300 text-gray-400 cursor-not-allowed bg-gray-100': disabled, // Estado deshabilitado
              'pl-10': icon !== '', // Espaciado para el ícono
            },
          )}
